from PyQt5.QtWidgets import QWidget, QPushButton, QVBoxLayout, QGroupBox, QGridLayout, QLabel, QLineEdit, QHBoxLayout
...
class Aplicacion_Gui(QWidget):
  ...
  def inicializar_GUI(self):
    ...
    # Creamos las etiquetas y campos de texto de la materia en la caja de materias
    self.etiqueta_nombre = QLabel('Nombre')
    self.txt_nombre = QLineEdit()
    self.txt_nombre.setReadOnly(True)  # Campo de texto de solo lectura
    ...
    # Agregamos las etiquetas y campos de texto a la caja de materias
    ...
    # Agregamos las cajas a la aplicación
